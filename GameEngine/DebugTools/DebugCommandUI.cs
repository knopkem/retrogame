    ...
    public class DebugCommandUI : DrawableGameComponent, IDebugCommandHost
    {
            ...
            : base(game)
        {
            ...
            RegisterCommand("cls", "Clear Screen",
                            delegate { lines.Clear(); });

            // Echo command
            RegisterCommand("echo", "Display Messages",
                            delegate(IDebugCommandHost host, string command, IList<string> args) { Echo(command.Substring(5)); });
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            rect.Height = (MaxLineCount*font.LineSpacing);

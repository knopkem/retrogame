...
namespace GameEngine.DebugTools
{
                                      ...
                                      IDebugCommandExecutioner, IDebugEchoListner
    {
        ...
        private readonly IDebugCommandHost commandHost;
        ...
        private readonly Regex packetRe = new Regex(@"\$(?<header>[^$]+)\$:(?<text>.+)");
        ...
        private ConnectionPahse phase = ConnectionPahse.None;
        ...
        {
            var commandUI = commandHost as DebugCommandUI;

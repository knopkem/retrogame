...
namespace GameEngine.DebugTools
{
    ...
    public class TimeRuler : DrawableGameComponent
    {
        ...
        private readonly List<MarkerInfo> markers = new List<MarkerInfo>();

        // Dictionary that maps from marker name to marker id.
        private readonly Dictionary<string, int> markerNameToIdMap = new Dictionary<string, int>();
        ...
        // Marker log string.
        private readonly StringBuilder logString = new StringBuilder(512);

...
namespace GameEngine.ScreenManager
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        private readonly Point prefScreenSize;
        ...
        private ScaledSpriteBatch spriteBatch;
        ...
        public Point PrefScreenSize
        {
            get { return prefScreenSize; }
        }

        public Matrix ScalingMatrix
        {
            get { return scalingMatrix; }
        }
            ...
            : base(game)
        {
            ...
            scalingMatrix = Matrix.CreateScale(drawingScale.X, drawingScale.Y, 1);

            prefScreenSize = new Point(1280, 720);

            input = new InputState();
        }

        /// <summary>
        /// Reset the viewport to its initial size
        /// </summary>
        public void ResetViewport()
        {
            if (isInitialized)
                GraphicsDevice.Viewport = initialViewport;
        }
        ...
        {
            base.Initialize();
            initialViewport = GraphicsDevice.Viewport;
            isInitialized = true;
        }
        ...
        protected override void LoadContent()
        {
            ...
            blankTexture = content.Load<Texture2D>("OtherTextures/blank");
            buttonBackground = content.Load<Texture2D>("OtherTextures/buttonBackground");
                ...
                if (storage.DirectoryExists("ScreenManager"))
                {
                    try
                    {
                        ...
                        if (storage.FileExists("ScreenManager\\ScreenList.dat"))
                        {
                            ...
                            using (IsolatedStorageFileStream stream = storage.OpenFile
                                ("ScreenManager\\ScreenList.dat", FileMode.Open, FileAccess.Read))
                            {
